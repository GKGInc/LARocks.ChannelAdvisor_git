...
{
    [Serializable()]
    public partial class StagingOrderFulfillmentsBO : MicroFour.StrataFrame.Business.BusinessLayer
    {
        ...
        /// </summary>
        public StagingOrderFulfillmentsBO()
            : base()
        {
            InitializeComponent();
        }
        ...
        public StagingOrderFulfillmentsBO(IContainer container)
            : base()
        {
            container.Add(this);
        ...
        protected StagingOrderFulfillmentsBO(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            InitializeComponent();
        }
        ...
        /// <param name="e"></param>
        /// <remarks></remarks>
        private void StagingOrderFulfillmentsBO_CheckRulesOnCurrentRow(CheckRulesEventArgs e)
        {
        ...
        /// </summary>
        /// <remarks></remarks>
        private void StagingOrderFulfillmentsBO_SetDefaultValues()
        {

...
{
    [Serializable()]
    public partial class StagingOrderFulfillmentsItemsBO : MicroFour.StrataFrame.Business.BusinessLayer
    {
        ...
        /// </summary>
        public StagingOrderFulfillmentsItemsBO()
            : base()
        {
            InitializeComponent();
        }
        ...
        public StagingOrderFulfillmentsItemsBO(IContainer container)
            : base()
        {
            container.Add(this);
        ...
        protected StagingOrderFulfillmentsItemsBO(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            InitializeComponent();
        }
        ...
        /// <param name="e"></param>
        /// <remarks></remarks>
        private void StagingOrderFulfillmentsItemsBO_CheckRulesOnCurrentRow(CheckRulesEventArgs e)
        {
        ...
        /// </summary>
        /// <remarks></remarks>
        private void StagingOrderFulfillmentsItemsBO_SetDefaultValues()
        {

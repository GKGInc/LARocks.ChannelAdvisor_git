...
{
    [Serializable()]
    public partial class StagingOrderHeaderBO : MicroFour.StrataFrame.Business.BusinessLayer
    {
        ...
        public StagingOrderHeaderBO(IContainer container)
            : base()
        {
            container.Add(this);
        ...
        protected StagingOrderHeaderBO(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            InitializeComponent();
        }
        ...
        {
            string sql = $"SELECT * FROM {this.TableNameAndSchema} WHERE ID = @id";
        ...
        /// <param name="e"></param>
        /// <remarks></remarks>
        private void StagingOrderHeaderBO_CheckRulesOnCurrentRow(CheckRulesEventArgs e)
        {
        ...
        /// </summary>
        /// <remarks></remarks>
        private void StagingOrderHeaderBO_SetDefaultValues()
        {
